...
(function() {
  var HrArticle, article, articleList, currentList, evalFilterFunction, filterByFunction, filterByList, filterByNumberList, outputMatchNumber, parseQueryString, queryForm, queryObject, theTag;
  ...
  filterByNumberList = function(numberList) {
    ...
    currentList = numberList.map(function(index) {
  ...
  filterByFunction = function(callback) {
    var numberList;
    numberList = [];
    currentList.map(callback).forEach(function(isTrue, index) {
      if (isTrue) {
