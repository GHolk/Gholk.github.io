...
(function() {
  var HrArticle, article, articleList, evalFilterFunction, filterByFunction, outputMatchNumber, parseQueryString, queryForm, queryObject, theTag;
  ...
  queryForm.onsubmit = function(evt) {
    ...
    return filterByFunction(evalFilterFunction(conditionStatement));
  };
